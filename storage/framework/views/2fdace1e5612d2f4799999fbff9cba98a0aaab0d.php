        ...
        <div class="col-md-2">
            <div class="row">
              <div class="btn-group-vertical col-md-12">
                <button type="button" class="btn btn-success btn-block"><i class="fa fa-pencil-square" aria-hidden="true"></i> Admin Panel</button>
                <a type="button" class="btn btn-default btngroup btn-block" href="/admin"><i class="fa fa-users" aria-hidden="true"></i> Users</a>
